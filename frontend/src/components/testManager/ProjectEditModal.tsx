...
const ProjectEditModal: React.FC<Props> = ({ isOpen, onClose, project }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
            ...
            <div className="relative w-full h-full sm:h-auto sm:max-w-2xl bg-white dark:bg-gray-800 sm:rounded-2xl shadow-2xl overflow-y-auto animate-[scaleIn_0.12s_ease-out]">
