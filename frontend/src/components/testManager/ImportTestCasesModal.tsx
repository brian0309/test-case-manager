                    ...
                    {step === 2 && (
                        <div>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <select
                                                ...
                                                className="mt-1 w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                                            >
                            ...
                            <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                                ...
                                />
                                <label htmlFor="skip-duplicates" className="text-sm text-gray-700 cursor-pointer">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-6">
                                <div className="p-4 bg-green-50 rounded-lg">
                                    ...
                                    <p className="text-2xl font-bold text-green-700 mt-2">{validCount}</p>
                                </div>
                                ...
                                <div className="p-4 bg-blue-50 rounded-lg">
                                    ...
                                    <p className="text-2xl font-bold text-blue-700 mt-2">{csvData.length}</p>
                                </div>
                            </div>
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="max-h-48 overflow-y-auto bg-red-50 rounded-lg p-4">
                                        <table className="w-full text-sm">
                                            <thead className="text-xs uppercase text-red-900 border-b border-red-200">
                                                <tr>
                            ...
                            {validationErrors.length === 0 && (
                                <div className="p-4 bg-green-50 rounded-lg flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-green-900">All rows are valid!</p>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-6">
                                <div className="p-4 bg-green-50 rounded-lg">
                                    ...
                                    <p className="text-2xl font-bold text-green-700 mt-2">{importResult.created}</p>
                                </div>
                                ...
                                <div className="p-4 bg-yellow-50 rounded-lg">
                                    ...
                                    <p className="text-2xl font-bold text-yellow-700 mt-2">{importResult.skipped}</p>
                                </div>
                                ...
                                <div className="p-4 bg-red-50 rounded-lg">
                                    ...
                                    <p className="text-2xl font-bold text-red-700 mt-2">{importResult.failed}</p>
                                </div>
                            </div>
                            ...
                            {importResult.skipped > 0 && importResult.duplicates && importResult.duplicates.length > 0 && (
                                <div className="mb-6 p-4 bg-yellow-50 rounded-lg">
                                    <div className="flex items-center gap-2 mb-2">
                                        <AlertCircle className="h-5 w-5 text-yellow-600" />
                                        <h3 className="text-sm font-semibold text-yellow-900">Skipped Duplicates</h3>
                                    </div>
                            ...
                            {importResult.failed > 0 && importResult.errors.length > 0 && (
                                <div className="mb-6">
                                    <div className="flex items-center justify-between mb-3">
                                        <div className="flex items-center gap-2">
                                            <AlertTriangle className="h-5 w-5 text-red-600" />
                                            <h3 className="text-sm font-semibold text-red-900">Import Errors</h3>
                                        </div>
                                        <button
                                            onClick={downloadErrorReport}
                                            className="text-xs text-red-700 hover:text-red-900 flex items-center gap-1 px-2 py-1 rounded hover:bg-red-100"
                                        >
